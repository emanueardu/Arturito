...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/assets/pets/loli', glob('assets/pets/loli/*')),
        ('share/' + package_name + '/assets/pets/pipi', glob('assets/pets/pipi/*')),
        ('share/' + package_name + '/assets/pets/joky', glob('assets/pets/joky/*')),
    ...
    entry_points={
        'console_scripts': [
            ...
            'pet_recognizer_node = robertito.pet_recognizer_node:main',
            'compass_node = robertito.compass_node:main',
            ...
            'smart_home_node = robertito.smart_home_node:main',
        ],
    },
)
